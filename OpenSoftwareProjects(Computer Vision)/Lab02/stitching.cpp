...
int main() {
	Mat I1, I2; //image1, image2

	// Read each image
	I1 = imread("C:\\Users\\MIN\\Desktop\\Lab02\\Img01.jpg", IMREAD_COLOR);
	I2 = imread("C:\\Users\\MIN\\Desktop\\Lab02\\Img02.jpg", IMREAD_COLOR);
...
//parameter: I1, I2:우리가 merge 할 image 2개 
